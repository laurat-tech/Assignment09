# ---------------------------------------------------------- #
# Title: Data Classes (Listing 6)
# Description: A module of data classes
# ChangeLog (Who,When,What):
# RRoot,1.1.2030,Created started script
# Laura Truong, 6.12.2020 Edited attributes to collect employee_ID in Employee(person)class
# ---------------------------------------------------------- #
...
class Employee(Person):  # Inherits from Person
    ...
    changelog: (When,Who,What)
        RRoot,1.1.2030,Created Class
        Laura Truong, 6.12.2020 Edited attributes to collect employee_ID
    """
